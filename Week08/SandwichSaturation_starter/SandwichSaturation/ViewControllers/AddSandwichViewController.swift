...
//
//    let newSandwich = Sandwich(context: AppDelegate().persistentContainer.viewContext)
...
//    let currentSauceAmount = try! context.fetch(SauceAmountModel.fetchRequest())

//    newSandwich.sauces?.sauceAmount = currentSauceAmount.first {
